    ...
    return (
        <AboutStyle>
            <div className="hero">
                ...
                <Typography variant="h4" fontWeight={700} className="hero-title">{t('about.title')}</Typography>
                <Typography variant="body2" color="var(--on-surface-variant)" className="hero-version">{t('about.version')}</Typography>
            </div>
            ...
            <div className="bento-grid">
                <div className="info-card">
                    <div className="info-card-header">
                        ...
                        <Typography variant="subtitle1" fontWeight={600}>{t('about.openSource.title')}</Typography>
                    </div>
                ...
                <div className="info-card">
                    <div className="info-card-header">
                        ...
                        <Typography variant="subtitle1" fontWeight={600}>{t('about.license.title')}</Typography>
                    </div>
                    <div className="info-row">
                        <Typography variant="body2" color="var(--on-surface-variant)" className="info-label">{t('about.license.title')}</Typography>
                    ...
                    <div className="info-row">
                        <Typography variant="body2" color="var(--on-surface-variant)" className="info-label">{t('about.tech.title')}</Typography>
